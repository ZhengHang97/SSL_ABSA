...
TRAIN_NUM = 100
data = pd.read_csv('../../data/SemEval/service/100-0.7200-0.5548.csv')
# data = pd.read_csv('../../data/SemEval/SemEval14_service_no_conflict.csv')
# print(data.label.value_counts())
# df1 = data[data['label'].isin([1])]
# df1 = df1.sample(n=40, replace=False, random_state=None, axis=0)
# df2 = data[data['label'].isin([2])]
# df2 = df2.sample(n=10, replace=False, random_state=None, axis=0)
# df3 = data[data['label'].isin([3])]
# df3 = df3.sample(n=50, replace=False, random_state=None, axis=0)
...
# df4 = df4.sample(n=40, replace=False, random_state=None, axis=0)
...
# df6 = df6.sample(n=50, replace=False, random_state=None, axis=0)
