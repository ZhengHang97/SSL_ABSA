...
TRAIN_NUM = 100
data = pd.read_csv('../../data/SemEval/anecdote/100-0.5700-0.5301.csv')
# data = pd.read_csv('../../data/SemEval/SemEval14_anecdote_no_conflict.csv')
# print(data.label.value_counts())
# df1 = data[data['label'].isin([1])]
# df1 = df1.sample(n=25, replace=False, random_state=None, axis=0)
# df2 = data[data['label'].isin([2])]
# df2 = df2.sample(n=30, replace=False, random_state=None, axis=0)
...
# df4 = df4.sample(n=25, replace=False, random_state=None, axis=0)
...
# data.to_csv(f'../../data/SemEval/anecdote/100-{result[0][0]:.4f}-{result[0][1]:.4f}.csv', sep=',', index=False)
# Initialize the model

inp_size = 768
n_classes = 4

model = LD(layer_sizes=[inp_size, 768, 300, n_classes])  # 768,768,300,4
print(model.summary())
