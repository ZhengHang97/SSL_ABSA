...
# print(data.COMPARISON.value_counts())  # 1:1, 2:15, 3:137, 4:59, 5:38

# df1 = data[data['COMPARISON'].isin([1])]
# df1 = df1.sample(n=1, replace=False, random_state=None, axis=0)
# df2 = data[data['COMPARISON'].isin([2])]
# df2 = df2.sample(n=15, replace=False, random_state=None, axis=0)
# df3 = data[data['COMPARISON'].isin([3])]
# df3 = df3.sample(n=48, replace=False, random_state=None, axis=0)
# df4 = data[data['COMPARISON'].isin([4])]
# df4 = df4.sample(n=22, replace=False, random_state=None, axis=0)
# df5 = data[data['COMPARISON'].isin([5])]
# df5 = df5.sample(n=14, replace=False, random_state=None, axis=0)
...
data = pd.read_csv('../../data/Peerread/COMPARISON/com_al-0.540-0.304.csv')

# get train/test data
x_train = data['comments'][:TRAIN_NUM]
y_train = data['COMPARISON'][:TRAIN_NUM]
x_test = data['comments'][TRAIN_NUM:]
y_test = data['COMPARISON'][TRAIN_NUM:]
