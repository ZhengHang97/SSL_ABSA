...
# print(data.SOUNDNESS.value_counts())  # 1:0, 2:1, 3:95, 4:40, 5:114

# df2 = data[data['SOUNDNESS'].isin([2])]
# df2 = df2.sample(n=1, replace=False, random_state=None, axis=0)
# df3 = data[data['SOUNDNESS'].isin([3])]
# df3 = df3.sample(n=36, replace=False, random_state=None, axis=0)
# df4 = data[data['SOUNDNESS'].isin([4])]
# df4 = df4.sample(n=23, replace=False, random_state=None, axis=0)
# df5 = data[data['SOUNDNESS'].isin([5])]
# df5 = df5.sample(n=40, replace=False, random_state=None, axis=0)
...
# model.save_weights(f"../../data/Peerread/SOUNDNESS/{accuracy:.3f}-{f1score:.3f}.h5")
# data.to_csv(f'../../data/Peerread/SOUNDNESS/sou_al-{accuracy:.3f}-{f1score:.3f}.csv', sep=',', index=False)